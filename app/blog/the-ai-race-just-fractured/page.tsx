...
const SLUG = 'the-ai-race-just-fractured';
  ...
  return (
    <>
      ...
      <EssayShell slug={SLUG} sources={sources}>
        <h2 id="the-ban">Act one: the US government switched off its own best weapons</h2>
        <p>
        ...
        <p>
          ...
          <em>
            “We disagree that the finding of a narrow potential jailbreak should be cause for recalling a
            commercial model deployed to hundreds of millions of people.”
          </em>
        </p>
        <p>
        ...
        <p>
          Council on Foreign Relations analyst Matthew Ferren put it plainly:{' '}
          <em>“the U.S. is losing the AI credibility war to itself.”</em> After the ban, Canadian Prime
          Minister Mark Carney warned G7 leaders directly that{' '}
          <em>“the export ban underscores the dangers of relying on U.S. models.”</em>
        </p>
        <p>
        ...
        <h2 id="japan-enters">Act two: Japan just proved you don’t need a frontier model to match one</h2>
        <p>
          The same week the US was banning its own AI, a Tokyo-based lab called{' '}
          <strong>Sakana AI</strong> launched something philosophically different from anything in the
          current frontier race: <strong>Fugu Ultra</strong>.
        </p>
        <p>
        ...
        <p>The benchmark numbers are striking:</p>
        <ul>
          <li>
            <strong>SWE Bench Pro (software engineering):</strong> Fugu Ultra scores 73.7, compared to
            Opus 4.8’s 69.2.
          </li>
          <li>
            <strong>GPQA-D (graduate-level science reasoning):</strong> Fugu Ultra reaches 95.5, matching
            top performers.
          </li>
          <li>
        ...
        <p>
          The marketing copy lands differently now that the ban has happened. Sakana advertises Fugu as
          delivering frontier performance <em>“without the risk of export controls.”</em> That line
          wasn’t theoretical when they wrote it. It’s documented recent history.
        </p>
        ...
        <p>
          What makes Japan’s entry significant beyond the benchmarks is the philosophical shift it
        ...
        <h2 id="china-rises">Act three: China’s open-weight stack is here and it’s serious</h2>
        <p>
          While Japan is winning on architecture and the US is losing on policy, China has been quietly
          stacking the leaderboards with open-weight models that organizations can download and
          self-host.
        </p>
        ...
        <h2 id="what-this-means">What this actually means for the race</h2>
        <p>
          A year ago, the AI race looked like a two-horse sprint between the US and China, with the US
        ...
        <p>
          China’s open-weight strategy is working precisely because it sidesteps the political risks that
          have now materialized in practice. You can’t export-control a model that’s already downloaded.
        </p>
        <p>
          The most honest read of this week:{' '}
          <strong>the AI race is becoming multipolar faster than anyone expected</strong>, and US policy
          choices are accelerating that transition rather than slowing it.
        </p>
        ...
        <p>
          ...
          systems are expensive upfront, and it’s not yet clear whether or at what pace existing
          datacenters get retrofitted.{' '}
          <strong>
        ...
        <ul>
          <li>
            <strong>Vendor concentration risk is no longer theoretical.</strong> If your architecture
            depends on a single frontier model from a single US vendor, last week showed what the tail
            risk looks like. It isn’t abstract anymore.
          </li>
          <li>
          ...
          <li>
            <strong>The AI race is multipolar.</strong> Japan is competing on architecture. China is
            competing on openness and accessibility. The US is competing on raw capability while
            undermining its own network effects through policy instability. Watching which bet pays out is
            going to be one of the defining technology stories of this decade.
          </li>
        </ul>
        <p className="signoff">
          ...
          . I write about AI, security, and the intersection of technology and governance.
        </p>
      </EssayShell>
    </>
  );
